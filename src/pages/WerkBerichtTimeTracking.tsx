/**
 * WerkBerichtTimeTracking — Matrix-basierter Werk-Bericht.
 *
 * STATUS: Work-in-Progress (Skelett, kopiert von TimeTracking.tsx).
 * Noch zu erledigen:
 *  - Bauvorhaben-Card entfernen + projektId-State raus
 *  - Tätigkeiten-State durch projektZeilen-State ersetzen (variable 1–12)
 *  - Save-Flow: bericht_typ='werk', projekt_id=NULL, time_entries Split per (MA × Projekt)
 *  - Edit-Flow: bericht_typ='werk' filter
 *  - PDF-Aufruf mit typ='werk'
 *  - Cross-Type-Warning auf LB+PL+LKW
 *  - Tagesgesamt-Card unten
 *
 * Bis dahin: nicht in App.tsx als Route registriert, daher unerreichbar für User.
 */
...
// Bericht-Typ für diese Seite (DB-Discriminator + time_entries.entry_typ).
const BERICHT_TYP = "werk" as const;
const TYP_LABEL = "Werk-Bericht";
const TAETIGKEIT_PREFIX = "Werk";
const MAX_PROJEKT_ZEILEN = 12;

const WerkBerichtTimeTracking = () => {
...
export default WerkBerichtTimeTracking;
